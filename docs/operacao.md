...
- Limitar `max_tokens` entre 100 e 1000 no primeiro uso, conforme o tipo de atendimento.
...
- O gateway limita respostas a 1000 tokens quando o cliente nao envia `max_tokens`.
